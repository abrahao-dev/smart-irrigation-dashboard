...
const TemperatureChart = ({ data, timeRange }) => {
  ...
  return (
    <div>
      <div className="mb-2 flex flex-wrap justify-between items-center text-xs text-danger-700 dark:text-danger-300">
        <div className="flex space-x-4">
          <span>Média: <strong>{formatNumber(stats.mean)}°C</strong></span>
          <span>Desvio Padrão: <strong>±{formatNumber(stats.stdDev)}°C</strong></span>
        </div>
        <div>
      ...
      <div className="h-60">
        <ResponsiveContainer width="100%" height="100%">
          ...
          <ReferenceLine
            ...
            strokeDasharray="3 3"
            label={{ 
              value: `Média: ${formatNumber(stats.mean)}°C`, 
          ...
          <Line 
            ...
            strokeWidth={2}
            dot={false}
            activeDot={{ r: 6, fill: "#EF4444", stroke: "#B91C1C", strokeWidth: 1 }}
